...
Config.PropertySettings = {
	EnableBanner = true, -- Activer ou non la bannière personnalisée, (Bannière Dynasty8)
...
Config.BuilderSettings = { 
    PropertiesType = 1,
    PropertyInfos = {},
    AnnounceList = {Index = 1, "~g~Ouvert~s~", "~r~Fermé~s~", "~b~Personnalisé~s~"},
	InteriorsList = {
		Index = 1, 
		"~b~Appartement Modeste~s~", "~b~Appartement (Motel)~s~",
		"~b~Appartement Moderne~s~", "~b~Appartement Luxueux #1~s~",
		"~b~Appartement Luxueux #2~s~", "~b~Appartement Luxueux #3~s~",
		"~b~Appartement Luxueux #4~s~", "~b~Maison Moderne #1~s~",
		"~b~Maison Moderne #2~s~", "~b~Bureau~s~",
		"~b~Bureau - (Stock)~s~", "~b~Bureau - (Avocat)~s~",
		"~b~Club de bikers~s~", "~b~Local~s~",
		"~b~Entrepôt (Petit)~s~", "~b~Entrepôt (Moyen)~s~",
		"~b~Entrepôt (Grand)~s~"
	},
    GarageList = {Index = 1, "~b~2 places~s~", "~b~4 places~s~", "~b~6 places~s~", "~b~10 places~s~"},
    StorageList = {Index = 1, "~g~50KG~s~", "~g~75KG~s~", "~g~125KG~s~", "~g~250KG~s~"},
	PropertyList = {Index = 1, "Tout", "Propriété(s)", "Garage(s)"},
    SellList = {Index = 1, "A soi", "Au joueur"},
